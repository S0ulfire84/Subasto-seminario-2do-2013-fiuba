    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <g:if test="${ tieneQueCalificarVendedor }">
        	...
        	<br/>
        	<g:form id="${ subastaPromocionalInstance.id }" class="formCalificarVendedor" name="formCalificarVendedor" action="calificarVendedor" method="post">
        ...
        <g:else>
        	...
        	<br/>
        	<g:form id="${ subastaPromocionalInstance.id }" class="formCalificarComprador" name="formCalificarComprador" action="calificarComprador" method="post">
        		<div class="form-group">
	        		<label for="selectEstadoTransaccion">¿C&oacute;mo finaliz&oacute; la transacci&oacute;n?</label>
	        		<g:select class="form-control" id="selectEstadoTransaccion" name="selectEstadoTransaccion" from="${estadosPosiblesTransaccion}"  />
        		</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="number" min="${ subastaPromocionalInstance.precioActual()+10 }" step="10" name="inputOferta" class="form-control" id="inputOferta" placeholder="en $ARS" value="${ subastaPromocionalInstance.precioActual()+10 }" >
		    </div>
		  </div>
		  <div class="form-group">
...
<script>
	...
	$( document ).ready(function() {
		...
		if ( "${subastaFinalizada}" == "false" ) {
		    ...
		    var tiempoFinalizacionSubasta = new Date(${subastaPromocionalInstance.finalizacion.getTime()});
	...
	$( "#botonCalificar" ).click(function() {
		...
		<div id="show-subasta" class="content scaffold-show" role="main">
			...
			<div class="message" role="status">${flash.message}</div>
				...
				<ol class="breadcrumb">
				  <li><g:link controller="categoria" action="show" id="${subastaPromocionalInstance?.categoria?.id}">${subastaPromocionalInstance?.categoria?.encodeAsHTML()}</g:link></li>
				  <li class="active">${subastaPromocionalInstance.titulo }</li>
				</ol>			
			
				<h1>${subastaPromocionalInstance?.titulo }</h1>
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-7">
							...
							<div class="panel panel-default">
							  ...
							  <div class="panel-body">
							    ${ subastaPromocionalInstance?.descripcion }
							  </div>
							</div>
						...
						<div class="col-md-5">
							<div class="well">
								<dl class="dl-horizontal">
									<h1>Precio actual: <span style="color:orange;">${ subastaPromocionalInstance.precioActual() }&#36; (ARS)</span></h1>
									<dt>Vendedor:</dt><dd>${ subastaPromocionalInstance.vendedor }</dd>
									<dt>Ofertas realizadas:</dt><dd>${ subastaPromocionalInstance.cantidadDeOfertasRealizadas() }</dd>
									<dt>Ganador actual:</dt><dd>${ subastaPromocionalInstance.quienVaGanando() }</dd>
								</dl>
